...
userUrl = "http://classic.austlii.edu.au/au/legis/nt/consol_act/dafva2007254/"
browser.get(userUrl)
...
#     ####~~~~~~~~~~~~~slice Division titles count how many divisions each part~~~~~~~~~~~~####  
#  div_idx=[]

#  ii=0
# for i in range(len(index_number)):
#     if ii<len(index_number)-1:
    
#         num=len(div_list[index_number[ii]:index_number[ii+1]])
#         div_idx.append(num)
#     else:
#          num=len(div_list[index_number[ii]:len(div_list)])
#          div_idx.append(num)
#     ii+=1      
...
# print(externalUrls)
NumofInternal = len(internalUrls)  - NumofExternal + 1
# print(internalUrls)
